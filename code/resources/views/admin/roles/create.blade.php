                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form method="POST" action="{{ route('role.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="form-group">
                                        <label for="spk_no" class="form-label">Role Name</label>
                                        <input type="text" class="form-control" id="name" autocomplete="off" name="name" placeholder="Enter Role Name" required>
                                    </div>
                                </div>
                                <br>
