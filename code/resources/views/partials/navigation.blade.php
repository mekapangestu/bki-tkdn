    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="/">
                <img src="{{ asset('assets/images/bki-logo.png') }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset('assets/images/bki-small.png') }}" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                                        ...
                                        <div class="notifications-menu" id="notification">
                                            ...
                                            @empty
                                                <a class="dropdown-item d-flex">
                                                    <div class="mt-1 wd-80p">
                                                        <h5 class="notification-label mb-1">Tidak ada notifikasi baru</h5>
                                                    </div>
                                                </a>
                                            @endforelse
                                        </div>
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{ asset('assets/images/149071.png') }}" alt="profile-user" class="avatar  profile-user brround cover-image">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
