                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <span style="color: red"><strong>Mohon untuk melengkapi dokumen sesuai dengan instruksi yang terdapat pada email anda.</strong></span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="file" id="formFileMultiple" autocomplete="off" name="sptjm" accept="application/msword, application/vnd.ms-excel, text/plain, application/pdf" required>
                                                </div>
                                            </div>
                                        </div>
                                        @forelse ($project->orders->siinas_data->produk ?? [] as $item)
                                            ...
                                            <div class="form-upload-{{ $item->id_produk }}">
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <input class="form-control" type="file" id="formFileMultiple" autocomplete="off" name="file[{{ $item->produk }}][]" accept="application/msword, application/vnd.ms-excel, text/plain, application/pdf" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-1">
